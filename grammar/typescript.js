...
var typescript = {trace: function trace() {
...
parse: function parse(input) {
    ...
    sharedState.yy.typescript = this;
...
parseError:function parseError(str, hash) {
        if (this.yy.typescript) {
            this.yy.typescript.parseError(str, hash);
        } else {
            throw new Error(str);
        }
    },
...
typescript.lexer = lexer;
function Parser () {
  this.yy = {};
}
Parser.prototype = typescript;typescript.Parser = Parser;
return new Parser;
})();
...
exports.Parser = typescript.Parser;
exports.parse = function () { return typescript.parse.apply(typescript, arguments); };
exports.main = function commonjsMain(args) {
    ...
    return exports.typescript.parse(source);
};
